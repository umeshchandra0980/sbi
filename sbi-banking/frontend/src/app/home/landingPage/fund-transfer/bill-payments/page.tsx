...
const MobilePrepaidIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <text x="12" y="13" fontSize="8" fontWeight="bold" textAnchor="middle" fill="#702082" stroke="none" fontFamily="sans-serif">₹</text>
    <circle cx="12" cy="18" r="0.8" fill="#702082" />
  </svg>
);

const DthIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
...
const CableTvIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="2" y="5" width="13" height="9" rx="1" strokeLinecap="round" strokeLinejoin="round" />
    <line x1="8.5" y1="14" x2="8.5" y2="17" />
    <line x1="5" y1="17" x2="12" y2="17" />
    <rect x="17" y="3" width="4" height="13" rx="0.5" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="19" cy="6" r="0.6" fill="#702082" />
    <circle cx="19" cy="9" r="0.6" fill="#702082" />
  </svg>
);
...
const BroadbandIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="4" y="14" width="16" height="5" rx="1" strokeLinecap="round" strokeLinejoin="round" />
    <line x1="12" y1="14" x2="12" y2="5" strokeLinecap="round" />
    <path d="M9 8c1.5-1.5 4.5-1.5 6 0" strokeLinecap="round" />
    <path d="M7 6c2.5-2.5 7.5-2.5 10 0" strokeLinecap="round" />
    <circle cx="7" cy="16.5" r="0.6" fill="#702082" />
    <circle cx="10" cy="16.5" r="0.6" fill="#702082" />
  </svg>
);
...
const MobilePostpaidIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <rect x="4" y="2" width="9" height="18" rx="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M13 5h6v12h-6" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M15 8h4M15 11h4M15 14h4" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M13 17l1.5-1 1.5 1 1.5-1 1.5 1" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="8.5" cy="17" r="0.6" fill="#702082" />
  </svg>
);
...
const PrepaidMeterIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M12 12l4-4" />
    <path d="m10 11 2 2h-2l2 2" stroke="#702082" strokeWidth="1.5" />
  </svg>
);
...
const LoanIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <text x="12" y="15.5" fontSize="10" fontWeight="bold" textAnchor="middle" fill="#702082" stroke="none" fontFamily="sans-serif">₹</text>
...
const MutualFundIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <text x="12" y="20.2" fontSize="8" fontWeight="bold" textAnchor="middle" fill="#702082" stroke="none" fontFamily="sans-serif">₹</text>
...
const NcmcIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <circle cx="10" cy="14" r="1" fill="#702082" />
    <circle cx="14" cy="14" r="1" fill="#702082" />
  </svg>
);
...
const ForexIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <text x="12" y="16" fontSize="11" fontWeight="bold" textAnchor="middle" fill="#702082" stroke="none" fontFamily="sans-serif">$</text>
  </svg>
);
...
const HousingIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    <path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" />
    <path d="M12 11c-1-1.5-3 0 0 2.5 3-2.5 1-4 0-2.5z" fill="#702082" stroke="none" />
  </svg>
);
...
const SubscriptionIcon = () => (
  <svg className="w-6 h-6 text-[#702082]" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5">
    ...
    <path d="m11 10.5 2.5 1.5-2.5 1.5v-3z" fill="#702082" />
  </svg>
);
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f9] flex flex-col font-sans">
      ...
      <main className="max-w-[1360px] w-full mx-auto p-8 space-y-6 flex-1">
        ...
        {/* Search Input Box */}
        <div className="w-full bg-white border border-slate-200/80 rounded-lg py-3 px-5 flex items-center select-none shadow-xs">
          ...
          <input 
            ...
            className="bg-transparent border-none outline-none text-xs w-full text-slate-850 placeholder-slate-400 font-sans font-medium" 
          />
        </div>
        ...
        <div 
          ...
          className="bg-white rounded-lg p-5 border border-slate-200/80 flex justify-between items-center cursor-pointer hover:bg-slate-50 transition-all select-none shadow-xs"
        >
        ...
        {/* Card 2: Bills Due */}
        <div className="bg-white rounded-lg p-6 border border-slate-200/80 shadow-xs select-none">
        ...
        <div className="space-y-4">
          <div className="space-y-1">
            <h2 className="text-[17px] font-bold text-[#702082] font-sans">
              Bill Categories
            </h2>
          ...
          <div className="space-y-4">
            {categories.map((cat, idx) => (
              <div 
                key={idx}
                className="bg-white border border-slate-200/80 rounded-lg p-6 shadow-xs select-none"
              >
                <h3 className="text-[14px] font-bold text-[#702082] mb-6 font-sans">
                  {cat.title}
                </h3>
                ...
                <div className="flex flex-wrap gap-x-12 gap-y-8 justify-start items-start">
                  {cat.items.map((item, itemIdx) => {
                    ...
                    return (
                      ...
                      >
                        <div className="w-12 h-12 flex items-center justify-center text-[#702082] group-hover:scale-105 transition-transform mb-1 bg-transparent shrink-0">
                          <Icon />
                        </div>
                        <span className="text-[11px] font-medium text-slate-700 font-sans tracking-wide leading-tight group-hover:text-purple-800 transition-all w-full">
                          {item.label}
                        </span>
                      </div>
                    );
