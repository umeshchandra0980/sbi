...
export default function FormGHHomePage() {
    ...
    <div className="min-h-screen bg-[#f4f0f8] font-sans text-slate-800 flex flex-col relative">
      ...
      <main className="flex-1 max-w-[1280px] w-full mx-auto px-4 py-6">
        ...
        <div className="flex items-center gap-2 text-xs font-semibold text-slate-600 mb-4">
          ...
          <ChevronRight size={13} className="text-slate-400" />
          <span className="text-[#673391] font-bold">Form 15G/H</span>
        </div>

        {/* Form Container Card with Tabs */}
        <div className="bg-white rounded-3xl p-6 md:p-8 shadow-xs border border-slate-100 min-h-[450px]">
          {/* Tabs */}
      ...
      {/* Centered Modal - Term Deposit Not Available (Exact Match to Image 3) */}
      {showModal && (
        <div 
