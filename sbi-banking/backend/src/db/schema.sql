-- SBI Banking Application Database Schema
...
CREATE TABLE accounts (
  ...
  today_transferred DECIMAL(15,2) DEFAULT 0.00,
...
CREATE TABLE transactions (
  ...
  narration TEXT,
  channel VARCHAR(20) DEFAULT 'internet_banking',
  ip_address INET,
  created_at TIMESTAMP DEFAULT NOW()
);
...
CREATE TABLE otps (
  ...
  purpose VARCHAR(30) NOT NULL CHECK (purpose IN ('login', 'transfer', 'registration', 'password_reset', 'unlock')),
